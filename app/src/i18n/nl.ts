...
export const nl = {
  ...
  dashboard: {
    ...
    nextUp: {
      title: 'Next up',
      nextClass: 'Volgende les',
      nextDeadline: 'Volgende deadline',
      todaySummary: 'Vandaag',
      todayCounts: '{classes} lessen · {deadlines} deadlines',
      noClasses: 'Geen komende lessen in je rooster.',
      noDeadlines: 'Geen deadlines bekend',
      now: 'nu',
      inTime: 'over {value}',
      ctaImportRoster: 'Importeer rooster',
      ctaViewWeek: 'Bekijk week',
    },
    todayEvents: {
      title: 'Vandaag',
      empty: 'Geen lessen gepland voor vandaag.',
      ctaMore: 'Bekijk meer',
    },
    eliteHeader: {
      title: 'Performance Index',
